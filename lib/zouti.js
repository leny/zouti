 ...
 */
"use strict";
var ERROR, SUCCESS, WARNING, _bIsMuted, _hash, bench, chalk, clearConsole, crypto, doNothing, kindOf, kindsOf, log, md5, mute, oBenches, sha1, sha256, sha512, sleep, spacer, uuid, whirlpool;
...
exports.spacer = spacer = function(iAmount) {
  if (iAmount == null) {
    iAmount = 1;
  }
  if (isNaN(iAmount = +iAmount)) {
    iAmount = 1;
  }
  while (iAmount--) {
    console.log();
